		...
		<a href="<?php echo base_url().'index.php/classify/index'?>" style="float:right;margin:10px 0 10px 20px;" class="btn btn-primary">添加分类</a>
		  ...
		  <?php
		   foreach($list as $key => $row) {
			   ...
			   $id = $row["cid"];
			   $n = $row["cname"];
			   $updateUrl = site_url("classify/toUpdate/".$id);
			   $removeUrl = site_url('classify/delete/'.$id);
			echo <<<EOF
			<tr id="{$id}">
